...
export const products: Record<ProductId, ProductDossier> = {
  quantrion: {
    ...
    groups: [
      {
        title: "Divisions",
        items: [
          { name: "Competitive Exams", detail: "Global Exam Atlas and the four-phase intelligence loop." },
          { name: "Explore Industries", detail: "Every industry. Every skill. One curriculum — 19 domains, 150+ courses." },
          { name: "Space Technology", detail: "Engineering humanity’s future beyond Earth." },
        ],
      },
      {
    ...
    ops: [
      { module: "Pathway engine", owner: "Learning", status: "In specification", latency: "Adaptive sequences", load: "Learning" },
      { module: "Knowledge DNA", owner: "Research", status: "In specification", latency: "Mastery graph", load: "Research" },
      { module: "Quiz synthesis", owner: "Content", status: "In build", latency: "Closed-loop practice", load: "Content" },
      { module: "Career routing", owner: "Product", status: "Specified", latency: "Pathway suggestions", load: "Product" },
    ],
  ...
  vdoc: {
    ...
    ops: [
      { module: "Scene renderer", owner: "Studio", status: "In specification", latency: "World continuity", load: "Studio" },
      { module: "Narrative model", owner: "Research", status: "In specification", latency: "Story graph", load: "Research" },
      { module: "Retention scorer", owner: "Product", status: "Specified", latency: "Afterglow signals", load: "Product" },
      { module: "Economy layer", owner: "Platform", status: "Specified", latency: "Ownership in-plot", load: "Platform" },
    ],
  ...
  exorax: {
    ...
    ops: [
      { module: "Intent graph", owner: "Commerce", status: "In specification", latency: "Natural-language search", load: "Commerce" },
      { module: "Catalog ranker", owner: "Merch", status: "Specified", latency: "Taste and constraints", load: "Merch" },
      { module: "3D / AR inspect", owner: "Experience", status: "Specified", latency: "Know it before it arrives", load: "Experience" },
      { module: "Decision loop", owner: "Product", status: "In specification", latency: "Feedback trains ranking", load: "Product" },
    ],
